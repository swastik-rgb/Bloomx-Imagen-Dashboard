...
description: Translates a structured ad configuration JSON payload into a high-fidelity formatted text design brief for the GPT Image 2 API. Use this skill when compiling the final text prompts.
---

# Design Brief Builder

This skill compiles a structured JSON ad payload into a formatted text design brief prompt according to the GPT Image 2 architecture template.

---

## WORKFLOW

### Step 1: Read the JSON Ad Payload
Accept the structured JSON object containing product images, display text, brand colors, style description, and reference images.

### Step 2: Compile the Design Brief Prompt
Plugs the JSON variables into the following exact template:

```text
You are an expert commercial advertising designer specializing in premium Interior Design, textile, Furniture, Floor Tiles, Hospitals, Resorts, and consumer product advertisements.
...
Body/Subheading Font: {{BODY_FONT}}
